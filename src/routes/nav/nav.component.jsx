...
import PhoneButton from "../../components/phone-button/phone-button.component";
		...
		<Fragment>
			<nav className="nav-bar pad-nav">
				<div className={"social-medias-container" + (isMobile ? " hide-content" : "")}>
					<Link to={"https://www.facebook.com/profile.php?id=61557189740001"} target="_blank" rel="noopener noreferrer">
			...
			<section>
				<SideModal isSideModalOpen={isSideModalOpen} onSideModalClose={closeSideModal} />
			</section>
			<Outlet />
		</Fragment>
	);
